...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "tabletmanagerdata.SchemaChangeResult" do
  ...
  add_message "tabletmanagerdata.IgnoreHealthErrorRequest" do
    optional :pattern, :string, 1
  end
  add_message "tabletmanagerdata.IgnoreHealthErrorResponse" do
  end
  add_message "tabletmanagerdata.ReloadSchemaRequest" do
    optional :wait_position, :string, 1
  end
  add_message "tabletmanagerdata.ReloadSchemaResponse" do
  end
  add_message "tabletmanagerdata.PreflightSchemaRequest" do
    repeated :changes, :string, 1
  end
  add_message "tabletmanagerdata.PreflightSchemaResponse" do
    repeated :change_results, :message, 1, "tabletmanagerdata.SchemaChangeResult"
  end
  ...
  add_message "tabletmanagerdata.ExecuteFetchAsAllPrivsRequest" do
    optional :query, :bytes, 1
    optional :db_name, :string, 2
    optional :max_rows, :uint64, 3
    optional :reload_schema, :bool, 4
  end
  add_message "tabletmanagerdata.ExecuteFetchAsAllPrivsResponse" do
    optional :result, :message, 1, "query.QueryResult"
  end
  ...
  add_message "tabletmanagerdata.VReplicationExecRequest" do
    optional :query, :string, 1
  end
  add_message "tabletmanagerdata.VReplicationExecResponse" do
    optional :result, :message, 1, "query.QueryResult"
  end
  add_message "tabletmanagerdata.VReplicationWaitForPosRequest" do
    optional :id, :int64, 1
    optional :position, :string, 2
  end
  add_message "tabletmanagerdata.VReplicationWaitForPosResponse" do
  end
  ...
  add_message "tabletmanagerdata.RestoreFromBackupRequest" do
  end
  add_message "tabletmanagerdata.RestoreFromBackupResponse" do
    optional :event, :message, 1, "logutil.Event"
  end
end
...
module Tabletmanagerdata
  ...
  SchemaChangeResult = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.SchemaChangeResult").msgclass
  ...
  IgnoreHealthErrorRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.IgnoreHealthErrorRequest").msgclass
  IgnoreHealthErrorResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.IgnoreHealthErrorResponse").msgclass
  ...
  ExecuteFetchAsAllPrivsRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.ExecuteFetchAsAllPrivsRequest").msgclass
  ExecuteFetchAsAllPrivsResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.ExecuteFetchAsAllPrivsResponse").msgclass
  ...
  VReplicationExecRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.VReplicationExecRequest").msgclass
  VReplicationExecResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.VReplicationExecResponse").msgclass
  VReplicationWaitForPosRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.VReplicationWaitForPosRequest").msgclass
  VReplicationWaitForPosResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.VReplicationWaitForPosResponse").msgclass
  ...
  RestoreFromBackupRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.RestoreFromBackupRequest").msgclass
  RestoreFromBackupResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("tabletmanagerdata.RestoreFromBackupResponse").msgclass
end
