...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "mysqlctl.ReinitConfigRequest" do
  end
  add_message "mysqlctl.ReinitConfigResponse" do
  end
  add_message "mysqlctl.RefreshConfigRequest" do
  end
  add_message "mysqlctl.RefreshConfigResponse" do
  end
end
...
module Mysqlctl
  ...
  ReinitConfigRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("mysqlctl.ReinitConfigRequest").msgclass
  ReinitConfigResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("mysqlctl.ReinitConfigResponse").msgclass
  RefreshConfigRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("mysqlctl.RefreshConfigRequest").msgclass
  RefreshConfigResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("mysqlctl.RefreshConfigResponse").msgclass
end
